...
ENV_DEPLOYMENT_NAME = "BDILAB_DEPLOYMENT_ID"
...
def get_deployment_name(default_val: str = NONIMPLEMENTED_MSG) -> str:
    """
    Get deployment name from `ENV_BDILAB_DEPLOYMENT_NAME` environment variable.
    If not set return `default_val`
    Parameters
    ----------
    default_val
    ...
    -------
       str
    """
    return os.environ.get(ENV_DEPLOYMENT_NAME, default_val)
